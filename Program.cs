...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Random dice = new Random(); // instantiate Random class
        ...
        // // Overloaded methods. They can be called with different parameters
        ...
        //     Console.WriteLine($"{daysUntilExpiration} days left. {discountPercentage}% discount");
        // }
        // else
        // {
        //     Console.WriteLine($"{daysUntilExpiration} days left. No discount");
        // }
